...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl card-shadow p-6">
        ...
        <form id="paymentForm" class="space-y-4">
            ...
            <!-- Voucher Code Section (Only for VODAFONE & TELECEL) -->
            <div id="voucherSection" class="hidden">
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                    <div class="flex items-start space-x-3">
                        <i class="fas fa-info-circle text-blue-600 mt-0.5"></i>
                        <div class="text-sm">
                            <p class="font-medium text-blue-800 mb-2">Generate Voucher Code Instructions:</p>
                            <ol class="text-blue-700 space-y-1 text-xs list-decimal list-inside">
                                <li>Dial <strong>*110#</strong> on your phone</li>
                                <li>Select option <strong>4: Make payments</strong></li>
                                <li>Select option <strong>6: Generate Voucher</strong></li>
                                <li>Enter your PIN number</li>
                                <li>You will receive an SMS containing a <strong>6-digit voucher code</strong></li>
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-1">Enter the 6-digit voucher code received via SMS</p>
                </div>
            </div>
...
<script>
    ...
    document.getElementById('paymentForm').addEventListener('submit', function(e) {
        ...
        // Validate voucher code for VODAFONE and TELECEL
        if ((data.network === 'VODAFONE' || data.network === 'TELECEL') && !data.voucher_code) {
            showAlert('Error', 'Please enter the 6-digit voucher code for ' + data.network);
            return;
        }

        if (data.voucher_code && data.voucher_code.length !== 6) {
            showAlert('Error', 'Voucher code must be exactly 6 digits');
            return;
        }
    ...
    document.querySelectorAll('.payment-option input[type="radio"]').forEach(radio => {
        radio.addEventListener('change', function() {
            ...
            if (this.checked) {
                ...
                // Show/hide voucher section based on network selection
                toggleVoucherSection(this.value);
            }
        });
    });

    // Function to show/hide voucher section for VODAFONE and TELECEL
    function toggleVoucherSection(network) {
