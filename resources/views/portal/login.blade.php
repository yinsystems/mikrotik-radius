...
<div class="space-y-6">
    ...
    <div id="loginForm" class="bg-white rounded-xl card-shadow p-6">
        ...
        <div class="mt-6 pt-4 border-t border-gray-200 text-center">
            <p class="text-gray-600 text-sm">
                ...
                <a href="{{ route('portal.register') }}" class="text-blue-600 hover:text-blue-700 font-medium">Register here</a>
            </p>
        </div>
    </div>
    ...
    <div id="otpForm" class="bg-white rounded-xl card-shadow p-6 hidden">
        <div class="text-center mb-6">
            ...
            <p class="text-gray-600 text-sm">Enter the 6-digit code sent to <span id="phoneDisplay" class="font-medium"></span></p>
            <p class="text-xs text-gray-500 mt-2">Code expires in <span id="countdown" class="font-medium text-red-600"></span></p>
        </div>
        ...
        <form id="verifyForm" class="space-y-4">
            ...
            <div>
                ...
                <div class="flex justify-center space-x-2 mb-4">
                    <input type="text" maxlength="1" class="otp-input w-10 h-12 text-center border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-lg font-medium"
            ...
            <div class="text-center">
                ...
                <p class="text-xs text-gray-500 mt-1">You can resend in <span id="resendCountdown">60</span> seconds</p>
            </div>
        </form>
