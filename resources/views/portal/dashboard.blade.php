                    ...
                    <div class="border-t border-green-200 pt-3">
                        <div class="grid grid-cols-2 gap-4 text-sm">
                            <div>
                                ...
                                <span
                                    class="font-medium">{{ $activeSubscription->starts_at->format('M j, Y H:i:s') }}</span>
                            </div>
                            <div>
                                <span class="text-gray-600">Expires:</span>
                                <span
                                    class="font-medium">{{ $activeSubscription->expires_at->format('M j, Y H:i:s') }}</span>
                            </div>
                        </div>
                ...
                <div class="bg-blue-50 rounded-lg p-4 mb-6">
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-2">
                            <span
                                class="font-mono bg-white px-3 py-1 rounded border text-blue-900">{{ $customer->phone }}</span>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-2">
                                @if($customer->hasValidInternetToken())
                                    <span id="currentToken"
                                          class="font-mono bg-white px-3 py-1 rounded border text-blue-900 text-lg font-bold tracking-wider">
                    ...
                    <div class="mt-3 p-3 bg-blue-100 rounded text-sm text-blue-800">
                        ...
                        @if($customer->hasValidInternetToken())
                            Use these credentials to connect to WiFi: Username ({{ $customer->phone }}) + Token
                            ({{ $customer->internet_token }})
                        @else
                            Purchase a subscription to get your WiFi token. You'll use your phone number as username and a
                            6-digit token.
                        @endif
                    </div>
                </div>
