...
return [
    ...
    */
    'templates' => [
        'welcome' => [
            'sms' => 'Welcome to MikroTik RADIUS! Account: {username}, Password: {password}. Connect using these credentials.',
            'email_subject' => 'Welcome to MikroTik RADIUS - Account Created',
            'email_body' => 'Welcome to MikroTik RADIUS! Your account has been created successfully. Username: {username}, Password: {password}. Please use these credentials to connect to our network.',
        ],
        'trial_assignment' => [
            'sms' => 'Free trial package "{package_name}" activated! Valid until {expires_at}. Enjoy your service!',
            'email_subject' => 'Trial Package Activated - {package_name}',
            'email_body' => 'Great news! Your trial package "{package_name}" has been activated and is valid until {expires_at}. Start enjoying our service right away!',
        ],
        'setup_instructions' => [
            'sms' => 'Setup: Username: {username}, Password: {password}. Connect to network and use these credentials.',
            'email_subject' => 'Network Setup Instructions',
            'email_body' => 'Network Setup Instructions: Username: {username}, Password: {password}. Please connect to our network and use these credentials for authentication.',
        ],
        'payment_success' => [
