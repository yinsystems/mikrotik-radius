...
return [
    ...
    */
    'notifications' => [
        ...
        'sms_template' => env('OTP_SMS_TEMPLATE', 'Your one-time password: {otp}. Expires in {minutes} min. Keep this code confidential and do not share with anyone, including our staff.'),
